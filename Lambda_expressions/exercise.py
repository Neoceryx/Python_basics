'''
Given the following funciton.
convert it to a lambra funciton
...
Convert it into lamba funciton
'''
...
Convert it a lambda to get a list whit no duplicates values
'''
...
# write lambda below
join_list_no_duplicates1 = lambda listA, listB: list(set(list_a + list_b))
print(join_list_no_duplicates(list_a, list_b))
...
g = create_quad_func(a=1, b=4, c=6)
print(f(2))
print(g(2))

# sorting whit lambdas
...
# sort by highest score. If Reverse = False = sort by lowest score
